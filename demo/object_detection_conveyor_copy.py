...
def draw_dots(frame):
    ...
    cv2.line(frame, (1230, 0), (1230, 1080), (255, 0, 0))
    ...
    while True:
        ...
        for i, contour in enumerate(contours):
            ...
            if (area_shape > 400):
                ...
                if x_mm != -1 and y_mm != -1:
                    block_coords.append([x_mm, y_mm])
                    block_rotations.append(-1 * angle)
        ...
        return block_coords, block_rotations
